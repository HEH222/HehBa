...
<main class="main-content">
  <a href="game.php" class="go-back"><i class="fas fa-arrow-left"></i> Go Back to Games</a>
   <a href="https://docs.google.com/forms/d/e/1FAIpQLSfC5_WVQjR8r5ivkyaZN7Q_M1cgqtdi3JAUrr0pHrvdUQ6vlQ/viewform?usp=header" class="Register"><i class="fas fa-arrow-right"></i> Register Here!!</a>
  <h1 class="page-title">FREEFIRE Tournament</h1>
  ...
  <div class="card">
    ...
    <a href="freefire_standings.php" class="btn">Go to Standings</a>
  </div>
