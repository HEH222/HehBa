...
<head>
  ...
  <title>PubG Tournament - View More</title>
...
<main class="main-content">
  ...
  <a href="https://docs.google.com/forms/d/e/1FAIpQLSe28qQY4_Pl87BAZfdTgrp3kqm_neAkhn1OC1uVsHoRwfR7tw/viewform?usp=header" class="Register"><i class="fas fa-arrow-right"></i> Register Here!!</a>
  <h1 class="page-title">PUBG Tournament</h1>

  <!-- Tournament Info -->
  <div class="card">
    <h3>How and When It Is Conducted</h3>
    <p>The PUBG Tournament will be held online from October 15–30, 2023. Matches will be scheduled on weekends to allow maximum participation from teams across different time zones.</p>
    <p>This tournament features a battle royale format with multiple rounds, culminating in a grand final. The grand finals will be streamed live on our official channels.</p>
  </div>

  <div class="card">
    <h3>Tournament Rules</h3>
    <ul class="rules-list">
      <li>All players must be registered with their main PUBG ID</li>
      <li>Squads must have exactly 4 players</li>
      <li>All matches will be played on the latest version of PUBG Mobile/PC</li>
    ...
    <a href="pubg_standings.php" class="btn">Go to Overall Standings</a>
  </div>
  ...
  <div class="card">
    ...
    <ul class="rules-list">
      ...
      <li>4th Place: $500</li>
      <li>MVP: Special Edition PUBG UC</li>
    </ul>
  </div>
