...
<head>
  ...
  <title>PUBG - Overall Standings</title>
  ...
  <style>
    ...
    *{margin:0;padding:0;box-sizing:border-box;font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;}
    ...
    .button-group button:hover{background:#00b8cc;color:#fff;transform: translateY(-2px);}
    ...
    table.standings th,table.standings td{padding:12px 15px;text-align:center;border:1px solid rgba(0,229,255,0.2);}
...
<body>
  ...
  <main class="main-content">
    <h1 class="page-title">PUBG Overall Standings</h1>
  ...
  <script>
    ...
    class Particle {
      constructor() {
        ...
        this.colorHue = Math.random() * 60 + 180; // Blue to cyan range (matching index.php)
    ...
    function animateParticles() {
      // Clear with semi-transparent background for trail effect (matching index.php)
    ...
    // Sample teams data
    const sampleTeams = [
      { rank: 1, team: "Team Alpha", matches: 12, chickenDinners: 4, kills: 78, posPoints: 120, score: 198 },
      { rank: 2, team: "Team Bravo", matches: 12, chickenDinners: 3, kills: 72, posPoints: 90, score: 162 },
      { rank: 3, team: "Team Charlie", matches: 12, chickenDinners: 2, kills: 68, posPoints: 80, score: 148 },
      { rank: 4, team: "Team Delta", matches: 12, chickenDinners: 2, kills: 65, posPoints: 75, score: 140 },
      { rank: 5, team: "Team Echo", matches: 12, chickenDinners: 1, kills: 62, posPoints: 70, score: 132 },
      { rank: 6, team: "Team Foxtrot", matches: 12, chickenDinners: 1, kills: 60, posPoints: 65, score: 125 },
      { rank: 7, team: "Team Golf", matches: 12, chickenDinners: 1, kills: 58, posPoints: 60, score: 118 },
      { rank: 8, team: "Team Hotel", matches: 12, chickenDinners: 1, kills: 55, posPoints: 55, score: 110 },
      { rank: 9, team: "Team India", matches: 12, chickenDinners: 0, kills: 52, posPoints: 50, score: 102 },
      { rank: 10, team: "Team Juliet", matches: 12, chickenDinners: 0, kills: 50, posPoints: 45, score: 95 },
      { rank: 11, team: "Team Kilo", matches: 12, chickenDinners: 0, kills: 48, posPoints: 40, score: 88 },
      { rank: 12, team: "Team Lima", matches: 12, chickenDinners: 0, kills: 45, posPoints: 35, score: 80 },
      { rank: 13, team: "Team Mike", matches: 12, chickenDinners: 0, kills: 42, posPoints: 30, score: 72 },
      { rank: 14, team: "Team November", matches: 12, chickenDinners: 0, kills: 40, posPoints: 25, score: 65 },
      { rank: 15, team: "Team Oscar", matches: 12, chickenDinners: 0, kills: 38, posPoints: 20, score: 58 },
      { rank: 16, team: "Team Papa", matches: 12, chickenDinners: 0, kills: 35, posPoints: 15, score: 50 },
      { rank: 17, team: "Team Quebec", matches: 12, chickenDinners: 0, kills: 32, posPoints: 12, score: 44 },
      { rank: 18, team: "Team Romeo", matches: 12, chickenDinners: 0, kills: 30, posPoints: 10, score: 40 },
      { rank: 19, team: "Team Sierra", matches: 12, chickenDinners: 0, kills: 28, posPoints: 8, score: 36 },
      { rank: 20, team: "Team Tango", matches: 12, chickenDinners: 0, kills: 25, posPoints: 6, score: 31 },
      { rank: 21, team: "Team Uniform", matches: 12, chickenDinners: 0, kills: 22, posPoints: 4, score: 26 },
      { rank: 22, team: "Team Victor", matches: 12, chickenDinners: 0, kills: 20, posPoints: 2, score: 22 },
      { rank: 23, team: "Team Whiskey", matches: 12, chickenDinners: 0, kills: 18, posPoints: 1, score: 19 },
      { rank: 24, team: "Team Xray", matches: 12, chickenDinners: 0, kills: 15, posPoints: 0, score: 15 },
      { rank: 25, team: "Team Yankee", matches: 12, chickenDinners: 0, kills: 12, posPoints: 0, score: 12 },
      { rank: 26, team: "Team Zulu", matches: 12, chickenDinners: 0, kills: 10, posPoints: 0, score: 10 },
      { rank: 27, team: "Team Ace", matches: 12, chickenDinners: 0, kills: 8, posPoints: 0, score: 8 },
      { rank: 28, team: "Team King", matches: 12, chickenDinners: 0, kills: 6, posPoints: 0, score: 6 },
      { rank: 29, team: "Team Queen", matches: 12, chickenDinners: 0, kills: 4, posPoints: 0, score: 4 },
      { rank: 30, team: "Team Jack", matches: 12, chickenDinners: 0, kills: 3, posPoints: 0, score: 3 },
      { rank: 31, team: "Team Ten", matches: 12, chickenDinners: 0, kills: 2, posPoints: 0, score: 2 },
      { rank: 32, team: "Team Nine", matches: 12, chickenDinners: 0, kills: 1, posPoints: 0, score: 1 }
    ];
    ...
    async function initializeDatabase() {
      try {
        ...
        // Clear existing data
        await db.ref("pubg_standings").remove();
        
        // Add new teams
        const promises = sampleTeams.map(team => 
          db.ref("pubg_standings/" + team.rank).set(team)
        );
    ...
    function loadStandings() {
      db.ref("pubg_standings").orderByChild("rank").once("value")
        .then(snapshot => {
